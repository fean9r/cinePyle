...
class Activity(object):
    ...
    def __init__(self, name, tInterval, value):    
        self.name = name.decode('utf-8')
        self.interval = tInterval
        self.value = value
...
class Show(Activity):
    ...
    def __init__(self, name, tInterval, value, director):   
        Activity.__init__(self, name, tInterval, value) 
